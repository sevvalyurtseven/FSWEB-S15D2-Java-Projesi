...
public class MainSetString {
    ...
    public static Set<String> findUniqueWords(){
        ...
        System.out.println("Before Process: " + Arrays.toString(words));
        System.out.println("Before Process: " + words.length);

        //2: words array'ini ArrayList'e cevir ve TreeSet'e parametre olarak yolla.Bu sayede kelimeler sıralanacak ve aynı kelime listede yer almayacak
